    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Welcome to GOHR</h2>
                <p class="text-gray-600">Sign in to your HR Management account</p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" 
                                   ...
                                   class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                ...
                <div class="mt-6">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-white text-gray-500">New to GOHR?</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center">
                <p class="text-xs text-gray-500">
                    © {{ date('Y') }} GOHR HR Management System. All rights reserved.
                </p>
            </div>
        </div>
    </div>
